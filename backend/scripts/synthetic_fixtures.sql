...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000001', 'Ahmad', 'Razak', 'MALE', '1990-05-15',
...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000002', 'John', 'Doe', 'MALE', '1988-11-20',
    'A12345678', 'PASSPORT', NULL,
    NULL, NULL, 'UNVERIFIED',
    NOW(), NOW()
);

-- 3. Secondary source only (ic_or_passport IS NULL, identification_value is present)
INSERT INTO persons (
    id, first_name, last_name, gender, dob,
    ic_or_passport, identification_type, identification_value,
    identification_hash, identification_hash_version, identification_verification_status,
    ...
    '00000000-0000-0000-0000-000000000003', 'Siti', 'Aminah', 'FEMALE', '1995-03-10',
    NULL, 'MALAYSIAN_IC', '950310-08-6666',
    NULL, NULL, 'UNVERIFIED',
    NOW(), NOW()
);
...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000004', 'Tan', 'Wei Ming', 'MALE', '1992-07-22',
...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000005', 'Muthu', 'Kumar', 'MALE', '1985-09-05',
...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000006', 'Empty', 'Identifier', 'FEMALE', '2000-01-01',
    '    ', 'MALAYSIAN_IC', NULL,
    NULL, NULL, 'UNVERIFIED',
    NOW(), NOW()
);
...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000007', 'Already', 'Migrated', 'MALE', '1993-12-12',
...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000008', 'Previously', 'Flagged', 'FEMALE', '1996-04-18',
...
INSERT INTO persons (
    ...
    '00000000-0000-0000-0000-000000000009', 'Duplicate', 'One', 'MALE', '1991-06-06',
    '910606-10-1234', 'MALAYSIAN_IC', NULL,
    NULL, NULL, 'UNVERIFIED',
    NOW(), NOW()
);

-- 10. Duplicate pair member B (same IC as fixture 9 -> should be FLAGGED)
INSERT INTO persons (
    id, first_name, last_name, gender, dob,
    ic_or_passport, identification_type, identification_value,
    identification_hash, identification_hash_version, identification_verification_status,
    ...
    '00000000-0000-0000-0000-000000000010', 'Duplicate', 'Two', 'MALE', '1991-06-06',
    '910606-10-1234', 'MALAYSIAN_IC', NULL,
    NULL, NULL, 'UNVERIFIED',
    NOW(), NOW()
);
