...
import { CaretRight, Users, Bell, UserPlus, Shield, Gift, Gear, SignOut, Pencil, X } from '@phosphor-icons/react';
        ...
        <>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-md animate-in fade-in duration-200">
                ...
                >
                    ...
                    <div className="px-6 py-1.5">
                        <div className="bg-gray-100 dark:bg-[#2C2C2E] rounded-xl overflow-hidden divide-y divide-gray-200 dark:divide-gray-700/50">
                            <MenuItem icon={<Gear className="w-5 h-5" />} label="Account Settings" />
                            <MenuItem
                                icon={<SignOut className="w-5 h-5 text-red-500" />}
                                label="Sign Out"
...
const MenuItem = ({ icon, label, onClick, className }: { icon?: React.ReactNode, label: string, onClick?: () => void, className?: string }) => (
    ...
    >
        ...
        <CaretRight className="w-4 h-4 text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300" />
    </button>
);
